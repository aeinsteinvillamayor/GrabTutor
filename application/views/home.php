  ...
  <div class="row">
    <div id = "main_nav"> 
      ...
      <div class = "_fbutt">
       ...
       <a href = "<?PHP echo base_url('index.php/c_register'); ?>">
        <div id = "_signup">
           Become a Tutor
        </div>
      </a>
      ...
      <div class="carousel-inner" role="listbox">
        <div class="item active">
          <div class="Panelo" id = "panel_uno"> 
            ...
            <div class = "butts">
            <a href = "<?PHP echo base_url('index.php/c_register'); ?>" >SIGN UP NOW</a>
            </div>
          </div>
        </div>
        ...
        <div class="item">
          <div class="Panelo" id = "panel_dos"> 
            ...
            <div class = "butts">
              <a href = "<?PHP echo base_url('index.php/c_register'); ?>" >FIND OUT MORE</a>
            </div>
          </div>
        </div>
        ...
        <div class="item">
          <div class="Panelo" id = "panel_tres"> 
            ...
            <div class = "butts">
              <a href = "<?PHP echo base_url('index.php/c_login'); ?>" >DISCOVER ONE NOW</a>
            </div>
          </div>
        </div>
